              ...
              <div className='flex items-center flex-wrap md:gap-14 gap-7'>
                <div>
                    <ul className='flex items-center gap-3 mt-7.5'>
                        ...
                        <li className='group'>
                            <Link href="#" >
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23" viewBox="0 0 22 23" fill="#A3BBD1" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:fill-primary dark:group-hover:fill-secondary"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 21l1.65 -3.8a9 9 0 1 1 3.4 2.9l-5.05 .9" /><path d="M9 10a.5 .5 0 0 0 1 0v-1a.5 .5 0 0 0 -1 0v1a5 5 0 0 0 5 5h1a.5 .5 0 0 0 0 -1h-1a.5 .5 0 0 0 0 1" /></svg>
                            </Link>
                        </li>
                        <li className='group'>
                            <Link href='#'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23" viewBox="0 0 23 23" fill="#A3BBD1" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:fill-primary dark:group-hover:fill-secondary"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                            </Link>
                        </li>
                    </ul>
                </div>
          ...
          <div
            ...
            <div className='lg:mt-0 mt-8  bg-white dark:bg-darkmode max-w-200 m-auto pt-8.75 pb-8 px-9.5 rounded-md relative z-10'>
              ...
              <form className='flex w-full m-auto justify-between flex-wrap gap-4'>
                ...
                <div className='w-full'>
                  <button
                    className='w-full bg-primary hover:bg-blue-700 dark:bg-blue-700 text-white py-3 rounded-lg'
                    type='submit'>
                    Submit Inquiry
                  </button>
                </div>
