        ...
        <div className="col-span-1 space-y-6">
          ...
          <div className="container p-5 justify-center border backdrop-blur-2xl border-black dark:border-white rounded-md shadow-md">
            <div className="mb-4 mt-3 w-full font-normal text-midnight_text dark:text-gray-200">
              I’m a medical doctor and full-stack engineer working at the
              intersection of clinical practice and modern software. After years
              at the bedside, I saw how slow systems, fractured workflows, and
              inaccessible data limit patient care. That led me into engineering
              — building tools with Python, JavaScript, and TypeScript that
              simplify processes, support decision-making, and move healthcare
              toward clarity.
            </div>
          </div>
          <Button
          ...
          {RESUME_ITEMS.map((props, idx) => (
            <>
              <div
                ...
                key={props.key}
              >
                <div className="h-12 w-12 shrink-0 items-center justify-center rounded-lg">
